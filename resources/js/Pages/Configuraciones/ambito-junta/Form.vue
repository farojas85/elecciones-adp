<template>
    <form @submit.prevent="guardar">
        <div class="modal fade" id="modal-ambito-junta">
...
export default {
    ...
    setup(props, { emit }) {
        ...
        const {
            errors, respuesta,
            agregarAmbitoJunta, actualizarAmbitoJunta
        } = useAmbitoJunta()

        const agregar = async() => {
            await agregarAmbitoJunta(form.value)
        ...
        const actualizar = async() => {
             await actualizarAmbitoJunta(form.value)
