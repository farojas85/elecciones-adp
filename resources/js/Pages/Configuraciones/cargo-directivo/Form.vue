<template>
    <form @submit.prevent="guardar">
        <div class="modal fade" id="modal-cargo-directivo">
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Cargo Directivo</h6>
...
export default {
    ...
    setup(props, { emit }) {
        ...
        const {
            errors, respuesta,
            agregarCargoDirectivo, actualizarCargoDirectivo
        } = useCargoDirectivo()
        ...
        const agregar = async() => {
            ...
            {
                $('#modal-cargo-directivo').modal('hide')
                ...
                emit('onCargoDirectivos')
            }
        }

        const actualizar = async() => {
             await actualizarCargoDirectivo(form.value)
